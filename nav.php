...
<div class="conatainer-fluid">
    <img class="img-fluid" src="../img/banner.jpg" alt="sushi poster" style="min-width: 100%;">
</div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if ($active2 === true){
                            echo "active";
                        } ?> " href="achievement.php">Achievements</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if ($active2 === true){
                            echo "active";
                    ...
                    <li class="nav-item">
                        <a class="nav-link disabled" href="character.php">Character sheet (WIP)</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Suggestions
                    ...
                    <li class="nav-item opacity-0" style="margin-left: 310px">
                        <a class="nav-link <?php if ($active2 === true){
                            echo "active";
