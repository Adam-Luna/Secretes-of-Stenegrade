<?php
    ...
    $query = $db->prepare("SELECT * FROM npc WHERE id=" .$_GET['id']);
    $query->execute();
    ...
    <div class="container-lg bg-primary bg-opacity-10" style="min-height: 62%; " >
        <div class="row">
            <div class="col-8 text-primary text-center ">
                ...
                ?>
                <br><br><br><br><br><br>
                <button class="btn-primary" onclick="window.location.href='npc.php'">back</button>
            </div>
            <div class="col-4">
                <br>
                <?php
                echo "<img class='img-fluid' src='../" . $data['img'] ."' style='min-width: 400px'>";
                ?>
